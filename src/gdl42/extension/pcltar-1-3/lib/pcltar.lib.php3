...
//  $g_pcltar_extension = substr(strrchr(basename($PATH_TRANSLATED), '.'), 1);
  $g_pcltar_extension = "php3";
  $path	= "./extension/pcltar-1-3/";
  ...
  {
    include($path.$g_pcltar_lib_dir."/pclerror.lib.".$g_pcltar_extension);
  }
  if (!defined("PCLTRACE_LIB"))
  {
    include($path.$g_pcltar_lib_dir."/pcltrace.lib.".$g_pcltar_extension);
  }
