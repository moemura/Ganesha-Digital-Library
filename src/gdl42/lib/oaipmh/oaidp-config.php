...
// By default GDL_SERVER_NAME is taken from the $_SERVER array. If it is different than your
// expected name, please change its value to your actual server name such as: my.server.name.com
define('GDL_SERVER_NAME', $_SERVER['SERVER_NAME']);

define('GDL_BASE_URL', 'http://'.GDL_SERVER_NAME.dirname($_SERVER['SCRIPT_NAME']));
...
$identifyResponse["earliestDatestamp"] = '1900-01-01';
...
$DB_HOST   = $gdl_db_conf["host"];
$DB_USER   = $gdl_db_conf["uname"];
$DB_PASSWD = $gdl_db_conf["password"];
$DB_NAME   = $gdl_db_conf["name"];					           
...
$SQL['table'] = $gdl_db_conf["prefix"] . '_metadata';
